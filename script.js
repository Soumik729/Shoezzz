...
const names = [
    ...
    [
        ...
        "Gray Nike Jordan 2 SP"
    ],
];

const descriptions = [
    [
        "Bring a piece of history to the city's urban streets as you walk into Nike Jordan Aura 3 men's sneakers. Inspired by the rich Jordanian heritage, this model has the enery of basketball shoes and a look tha changes the perception of the classic style.",
    ],
    [
        "Nike Air Max 95 men's sneakers move you with the strength and fluidity inspired byu the anatomy of the human body. The central sole forms the basis of these sneakers, while the structured side panles give a solid and stable construction. Flexible incisons in the sole allow your feet to move natufrally.",
    ],
    [
        "Jordan Delta 2 SP men's basketball shoes offer a fresh and fearless approach to the characteritics you want: durability, comfort and the attitude of the Jordan brand. The first model of Delta 2 sneakers, with the same idea, received redesigned lines and modified components.",
    ],
];
